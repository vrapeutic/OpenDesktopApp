...
const handleStartAppMessage = (event: IpcMainInvokeEvent, args: any[]) => {
    console.log(`received a start app request, message: ${args}`);
  }
...
const createWindow = (): void => {
  ...
  ipcMain.on("start-app",handleStartAppMessage);
};
