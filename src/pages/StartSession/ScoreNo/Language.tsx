import {
  ...
  const Language = (props: any) => {
    ...
    const handleFormSubmit = async (data: any) => {
        console.log( props.formData[0],
            props.formData[1],
            props.formData[2],
           props.formData[3], data.selectDistractors,)
      ...
      console.log(updatedFormData,"tttttt")
      console.log('all subimtted data in distractor langauge', updatedFormData);
      navigate('/home');
      props.onClose();
          ...
          <ModalContent h="400px" w="500px" bgColor="#FFFFFF" borderRadius="10px">
            ...
            <ModalBody fontSize="20px" fontWeight="600" mt="25px">
              <FormControl isInvalid={!!errors.selectDistractors}>
                ...
                <FormErrorMessage>
                  {errors.selectDistractors && 'Please select a Language  .'}
                </FormErrorMessage>
              </FormControl>
            </ModalBody>
