...
class RadialChart extends React.Component {
  state: any = {series: [ ], options: { }, id: ""}
      ...
      this.state = {
        ...
        stroke: {
         ...
         legend: {
            ...
            customLegendItems: ['good session percentage' , 'vr percentage', 'kids using vr percentage '],
            offsetX: -1,
            offsetY: 40,
            labels: {
                colors: '#5A5881',
    ...
    async componentDidMount(){
      ...
      await fetch(`${config.apiURL}/api/v1/doctors/center_statistics?center_id=${this.props.centerId}`,{
        method: 'Get',
        redirect: 'follow',
