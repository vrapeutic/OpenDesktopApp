    ...
    const sideItems = [
        {
            ...
            icon: (
                <Dashboard
                    color={location.pathname === "/doctors" ? "#00DEA3" : "#333333"}
                />
            ),
            path: "/doctors",
        },
        {
            ...
            icon: (
                <Kids
                    color={
                        location.pathname === "/Kids" ? "#00DEA3" : "#333333"
                    }
                />
            ),
            path: "/Kids",
        },
        {
            ...
            icon: (
                <Theraputicmodules
                    color={
                        location.pathname === "/Theraputicmodules"
                            ? "#00DEA3"
                            : "#333333"
                    }
                />
        ...
        },
        {
            ...
            icon: (
                <Therapycenters
                    color={
                        location.pathname === "/Therapycenters"
                            ? "#00DEA3"
                            : "#333333"
                    }
                />
        ...
        },
        {
            ...
            icon: (
                <Assessmenttools
                    color={
                        location.pathname === "/Assessmenttools"
                            ? "#00DEA3"
                            : "#333333"
                    }
                />
        ...
        },
        {
            ...
            icon: (
                <Setting
                    color={
                        location.pathname === "/Setting" ? "#00DEA3" : "#333333"
                    }
                />
            ),
            path: "/Setting",
