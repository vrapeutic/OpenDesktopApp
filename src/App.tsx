...
import AddTherapycenters from "./pages/AddTherapycenters";
...
import HeaderTherapyCenter from "./pages/HeaderTherapycenter";
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="HeaderTherapyCenter" element={<HeaderTherapyCenter />} />
          <Route path="HeaderTherapyCenter" element={<HeaderTherapyCenter />} />
          <Route path="Branches" element={<Branches />} />
          <Route path="Specialists" element={<Specialists />} />
          <Route path="Assessmenttools" element={<Assessmenttools />} />
          <Route path="setting" element={<Setting />} />
          <Route path="AddTherapycenters" element={<AddTherapycenters />} />
